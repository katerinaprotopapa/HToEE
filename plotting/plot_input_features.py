...
def main(options):
    ...
    with open(options.config, 'r') as config_file:
        ...
        list_vars = ['diphotonPt','leadJetPt','leadPhotonEta','leadPhotonIDMVA','subleadJetPt','subleadPhotonEta','subleadPhotonIDMVA', 'diphotonMass', 'dijetMass', 'dijetAbsDEta', 'dijetDPhi', 'diphotonCosPhi', 'leadJetPUJID', 'subleadJetPUJID'
                    ...
                    , 'leadJetMass', 'leadPhotonEn', 'leadPhotonPt'
                    , 'subleadJetMass', 'subleadPhotonEn','subleadPhotonPt'
                    , 'diphotonEta', 'diphotonPhi',
                    'leadPhotonPhi','leadJetDiphoDEta','leadJetDiphoDPhi','leadJetEn','leadJetEta','leadJetPhi',
                    'subleadPhotonPhi',
                    #'subsubleadPhotonEn',
                    'subsubleadJetMass',
                    #'subsubleadPhotonPt','subsubleadPhotonEta','subsubleadPhotonPhi',
                    'subleadJetDiphoDPhi',
                    'subleadJetDiphoDEta','subleadJetEn','subleadJetEta','subleadJetPhi',
                    #'subsubleadPhotonIDMVA',				
                    'diphotonEta','diphotonPhi','dijetPt','dijetEta','dijetPhi','dijetMinDRJetPho','dijetDiphoAbsDEta',
                    'nSoftJets', 'diphotonSigmaMoM',
                    ...
                    #'leadJetID',
                    #'leadTrkDxy','leadTrkDz','leadTrkPfRelIso03All','leadTrkPfRelIso03Chg','leadTrkMiniPFRelIsoAll',
